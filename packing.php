  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <div class="col-md-7">
        ...
        <?php if (isset($added_box)) : ?>
          <div class="alert alert-success">
            <!-- Display generated box information and barcode -->
            ...
            <?php if (isset($product_name)) : ?>
              ...
              <br>
            <?php endif; ?>
            Box Number: <?php echo $added_box['box_name']; ?>
            <br>
            Storage Area: <?php echo $added_box['storage_area']; ?>
            <br>
